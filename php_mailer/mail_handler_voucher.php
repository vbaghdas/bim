...
$message .= "<tbody>
       ...
       <tr>
       <td colspan='4' style='padding:15px; color: #333; text-align: center;'>
       <p style='font-size:18px;'>Hello ".$name.",</p>
       <hr />
       <p style='font-size:18px; color: #333;'>Thank you for opting in for your voucher.</p>
       <p style='font-size:18px; color: #333;'>Due to the limited number of vouchers available, they will be redeemable on a first-call basis so call to book your appointment today!</p>
       <p style='font-size:22px; color: #333;'>BONUS! Call to schedule now and get 4 adjustments for only $79!</p>
       <p style='font-size:22px; color: #333;'>CALL NOW: (818) 782-2225</p>
       <p style='font-size:18px; color: #333;'>Voucher Code to redeem offer is BIMChiro</p>
       <img src='http://www.bimhealthcenter.com/img/service_1.jpg' style='height:auto; width:100%; max-width:100%;' />
       </td>
       </tr>
